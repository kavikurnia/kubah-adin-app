import {$,esc,table,form,select,area,bindForm,message,date} from './planning-ui.js?v=picker-20260923-r21';
import {customerMessages,PROGRAMS,MESSAGE_STATUS,messageNumber} from './customer-message-service.js?v=picker-20260923-r21';
