import {caseId} from './return-domain.js?v=products-20260917-r16';
import {policyDraft} from './return-domain.js?v=products-20260917-r16';
import {commerce} from './manual-service.js?v=products-20260917-r16';
...
import {claimInput,claimEvidence} from './buyer-domain.js?v=products-20260917-r16';
...
export async function manualApi(c,action,d={}){
  ...
  const core=commerce(store,{verifyFile:async file=>{const {documentStorage}=await import('./document-storage.js?v=products-20260917-r16');await documentStorage(c).read(file);}});
