import {caseId} from './return-domain.js?v=picker-20260923-r21';
import {policyDraft} from './return-domain.js?v=picker-20260923-r21';
import {commerce} from './manual-service.js?v=picker-20260923-r21';
import {config,validateConfig,check,id,str,num,hash,cartInput,address,priceCart,validateSlot} from './manual-domain.js?v=picker-20260923-r21';
...
import {catalogEstimate,quoteSignature} from './catalog-domain.js?v=picker-20260923-r21';
import {claimInput,claimEvidence} from './buyer-domain.js?v=picker-20260923-r21';
...
export async function manualApi(c,action,d={}){
  ...
  const core=commerce(store,{verifyFile:async file=>{const {documentStorage}=await import('./document-storage.js?v=picker-20260923-r21');await documentStorage(c).read(file);}});
