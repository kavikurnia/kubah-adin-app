...
export async function api(action,data={}){
 ...
 try{const result=await withDeadline(import('./manual-api.js?v=picker-20260923-r21').then(m=>{guard();return m.manualApi(c,action,data);}),30000,'manual/unavailable');guard();return result;}
