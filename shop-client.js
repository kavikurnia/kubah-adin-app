...
export async function api(action,data={}){return withDeadline(import('./manual-api.js?v=admin-lengkap-20260909-r2').then(async m=>m.manualApi(await connect(),action,data)),30000,'manual/unavailable');}
