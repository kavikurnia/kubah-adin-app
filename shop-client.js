...
export async function api(action,data={}){return withDeadline(import('./manual-api.js?v=katalog-pembeli-20260909-r7').then(async m=>m.manualApi(await connect(),action,data)),30000,'manual/unavailable');}
